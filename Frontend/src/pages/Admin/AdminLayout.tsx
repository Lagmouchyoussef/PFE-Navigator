        ...
        <div className="sidebar-group">
          ...
          <AnimatePresence initial={false}>
            {(isSidebarCollapsed || expandedGroups.principal) && (
              ...
              >
                <SidebarLink to="/admin/dashboard" icon={<LayoutDashboard size={20} />} iconClassName="icon-primary" label={!isSidebarCollapsed && "Dashboard"} />
                <SidebarLink to="/admin/users" icon={<Users size={20} />} iconClassName="icon-indigo" label={!isSidebarCollapsed && "User Management"} />
                <SidebarLink to="/admin/subjects" icon={<BookOpen size={20} />} iconClassName="icon-primary" label={!isSidebarCollapsed && "Subject Approval"} />
                <SidebarLink to="/admin/grades" icon={<Award size={20} />} iconClassName="icon-primary" label={!isSidebarCollapsed && "Grades Management"} />
                <SidebarLink to="/admin/jury" icon={<Calendar size={20} />} iconClassName="icon-success" label={!isSidebarCollapsed && "Jury Planning"} />
                <SidebarLink to="/admin/projects" icon={<Briefcase size={20} />} iconClassName="icon-warning" label={!isSidebarCollapsed && "Project Archive"} />
                <SidebarLink to="/admin/analytics" icon={<BarChartIcon size={20} />} iconClassName="icon-danger" label={!isSidebarCollapsed && "Analytics"} />
              </motion.nav>
            )}
          </AnimatePresence>
        </div>
          ...
          <AnimatePresence initial={false}>
            {(isSidebarCollapsed || expandedGroups.communication) && (
              <motion.nav
                ...
                className="nav flex-column gap-1 px-3 overflow-hidden"
              >
                <SidebarLink to="/admin/resources" icon={<Briefcase size={20} />} iconClassName="icon-orange" label={!isSidebarCollapsed && "Resources"} />
          ...
          <div className="d-flex align-items-center gap-3 flex-grow-1">
            ...
            {user && (
              <div className="breadcrumb-box d-none d-xl-flex align-items-center gap-2 extra-small text-muted fw-bold text-uppercase tracking-wider">
                ...
                <span className="text-primary">Admin Space</span>
              </div>
            )}
          </div>
            ...
            <Dropdown align="end">
              ...
              <Dropdown.Menu className="border-0 shadow-lg mt-3 p-0 overflow-hidden" style={{ width: '320px', borderRadius: '16px' }}>
                <div className="px-3 py-3 border-bottom d-flex justify-content-between align-items-center bg-surface-alt">
                  <span className="fw-bold text-navy">Direct Messages</span>
              ...
              <Dropdown.Menu className="border-0 shadow-lg mt-3 p-0 overflow-hidden" style={{ width: '320px', borderRadius: '16px' }}>
                ...
                <div className="p-0 overflow-y-auto" style={{ maxHeight: '400px' }}>
                  {notifications.length === 0 ? (
                    <div className="p-4 text-center text-muted extra-small fw-bold">No notifications</div>
                  ) : (
                    notifications.map(n => (
                      <NotificationItem 
                        key={n.id}
            ...
            <Dropdown align="end">
              ...
              >
                <div className="d-flex flex-column text-end d-none d-md-flex">
                  ...
                  <span className="text-muted fw-black uppercase" style={{ fontSize: '10px', letterSpacing: '0.5px' }}>Administrator</span>
                </div>
